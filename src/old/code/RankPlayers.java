...
public class RankPlayers {
	static public String ranklist(String[] players, String[] results) {
		String r = "";
		...
		Collections.sort(lis, new Comparator<nat>() {
			public int compare(nat n1, nat n2) {
				...
				if (m == 0)
					m = Integer.parseInt(n1.ID) - Integer.parseInt(n2.ID);
				return m;
			}
		});
	...
	public static void main(String[] args) {
		...
		String x = RankPlayers.ranklist(m, r);
		System.out.print(x);
